...
║    • Unified Trading Bot (Options + Equity)                          ║
...
╚════════════════════════════════════════════════════════════════════════╝
        ...
        print("   • Setting up Unified Trading Bot...")
        ...
        # Add SPY
        print("   • Adding SPY to trading bot...")
        await self.bot.add_symbol("SPY")
                ...
                if results:
                    ...
                    if alerts:
                        ...
                        for alert in alerts[:3]:
                            ...
                            # Add to bot if alert is strong
                            if alert.symbol not in self.bot.active_symbols:
                                print(f"   → Adding {alert.symbol} to active trading")
